...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--source-cache", default="data/cache/features/fabwave")
    ...
    parser.add_argument("--output-cache", default="data/cache/features/fabwave_no_rotary_shaft")
